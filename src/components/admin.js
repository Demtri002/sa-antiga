...
const Admin = () => {
    ...
    const getUsers = async () => {
        try{
            const response = await fetch('http://10.3.62.238:3000/users/')
    ...
    const getDenuncia = async () => {
        try{
            const response = await fetch('http://10.3.62.238:3000/denuncia/')
            const json = await response.json()
            setData(json)
        }catch (error) {
            console.error(error)
    ...
    const deleteDenuncia = async (id) => {
        ...
        try{
            ...
            console.log("ID:" + id)
            await fetch('http://10.3.62.238:3000/denuncia/' + id, requestOptions)
